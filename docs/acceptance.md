...
- v0.3.0 完整工厂镜像由真实 ESP32-P4 工具链构建并逐组件复验：16,711,680 Bytes，SHA-256 `7aad8847dcbaa11634110729d223ed1ee322d969abb27c91368de2fd576f1376`。
...
这些入口、协议和记录字段已经就绪；恢复连接后只做物理验收，不需要重新设计软件架构。
